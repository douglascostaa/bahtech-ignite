...
const steps = [
  ...
  { year: "2022", role: "Trainee", desc: "Primeiro contato corporativo na Compass.UOL — ritmo de empresa, sprints, code review" },
  ...
  <SlideLayout>
    <div className="relative z-10 flex flex-col justify-center h-full px-[140px]">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
        ...
        <h2 className="font-display text-[72px] font-bold leading-[1.1] text-foreground mb-4">
          A Escada do <span className="slide-gradient-text">Dev</span>
        </h2>
        <p className="text-[22px] text-slide-gray-light mb-14">
          Trajetória na Compass.UOL — cada degrau constrói o próximo
        </p>
      </motion.div>
