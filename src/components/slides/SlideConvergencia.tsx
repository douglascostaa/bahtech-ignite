  ...
  <SlideLayout>
    <div className="relative z-10 flex items-center h-full px-[140px]">
      ...
      <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} className="flex-1 pr-16">
        ...
        <h2 className="font-display text-[68px] font-bold leading-[1.1] text-foreground mb-8">
          A <span className="slide-gradient-text">Convergência</span><br/>dos Papéis
        </h2>
      ...
      <motion.div initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }}
        ...
        <div className="relative w-[600px] h-[550px]">
          ...
          {/* Product Managers circle - bottom left */}
