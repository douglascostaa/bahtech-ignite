  ...
  <SlideLayout>
    ...
    <div className="relative z-10 flex flex-col justify-center h-full px-[140px]">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
        ...
        <h2 className="font-display text-[80px] font-bold leading-[1.1] text-foreground mb-4">
          O Alicerce <span className="slide-gradient-text">Técnico</span>
        </h2>
        <p className="text-[24px] text-slide-gray-light mb-14">
          A academia como trampolim — não como destino
        </p>
      </motion.div>
