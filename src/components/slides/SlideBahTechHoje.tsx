  ...
  <SlideLayout>
    <div className="relative z-10 flex items-center h-full px-[140px]">
      <motion.div initial={{ opacity: 0, x: -40 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.7 }}
        ...
        <h2 className="font-display text-[80px] font-bold leading-[1.1] text-foreground mb-6">
          BahTech <span className="slide-gradient-text">Hoje</span>
        </h2>
        <div className="flex items-baseline gap-3 mb-10">
          <span className="text-[72px] font-display font-bold slide-gradient-text">21</span>
